...
<template>
  <div class="visual-swipe">
    <div class="visual-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="visual-swipe-indicators" v-show="showIndicators">
      <div class="visual-swipe-indicator"
...
<script>
  import { once } from '@/wind-dom/event';
  import { addClass, removeClass } from '@/wind-dom/class';
